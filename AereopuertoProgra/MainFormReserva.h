...
namespace AereopuertoProgra {
    ...
    // Definición de la clase MainFormReserva que hereda de System::Windows::Forms::Form
    public ref class MainFormReserva : public System::Windows::Forms::Form {
    public:
        // Constructor de la clase MainFormReserva
    ...
    protected:
        // Destructor de la clase MainFormReserva
        ~MainFormReserva() {
            if (components) {
    ...
    private:
        ...
        System::Windows::Forms::TextBox^ textBoxRuta; // TextBox para la ruta
        System::Windows::Forms::TextBox^ textBoxFecha; // TextBox para la fecha
        System::Windows::Forms::TextBox^ textBoxHoraAbordaje; // TextBox para la hora de abordaje
        System::Windows::Forms::TextBox^ textBoxHoraSalida; // TextBox para la hora de salida
        System::Windows::Forms::TextBox^ textBoxHoraLlegada; // TextBox para la hora de llegada
        System::Windows::Forms::TextBox^ textBoxNumeroVuelo; // TextBox para el número de vuelo
        System::Windows::Forms::TextBox^ textBoxAsiento; // TextBox para el asiento
